...
### Exercise 9
This would see them as individuals and because there are many repeaded years, the data would be extended out more than it needs to be.

### Exercise 10

```{r Major, eval = T}
ggplot(earthquakes, aes()) %>% 
